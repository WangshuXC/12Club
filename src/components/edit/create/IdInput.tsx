          ...
          content={
            <>
              <p className="text-sm whitespace-pre-wrap p-2">
                动漫和小说的DB ID优先采用
                <ExternalLink link="https://bangumi.tv/anime" target="_blank">
                  bangumi
                </ExternalLink>
                的项目id
                <br />
                例如《恋人不行》的链接为https://bangumi.tv/subject/524707，则DB
                ID为a524707（若id不足6位请在前面补0）
                <br />
                <br />
                游戏的DB ID优先采用vndb的项目id
                <br />
                简介、发行等相关数据和资源也可于
                <ExternalLink link="https://touchgal.us" target="_blank">
                  touchgal
                </ExternalLink>
                上查找
                <br />
